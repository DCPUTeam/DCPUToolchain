...
generate("mli", "Signed Multiply", "MLI", "S+", function(a, b) return (a - 0x8000) * (b - 0x8000); end)
generate("dvi", "Signed Divide", "DVI", "S-", function(a, b) return math.floor((a - 0x8000) / (b - 0x8000)); end)
generate("mod", "Modulo", "MOD", "%", function(a, b) return a % b; end)
generate("mdi", "Signed Modulo", "MDI", "S%", function(a, b) return (a - 0x8000) % (b - 0x8000); end)
