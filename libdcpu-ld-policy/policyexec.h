...
///
typedef void (*policy_call_offset_t)(int position);
...
///
typedef void (*policy_call_write_t)(list_t words);
...
///
typedef int (*policy_call_total_table_t)(int table);
...
///
typedef int (*policy_call_total_section_t)(bstring section);
...
///
typedef list_t (*policy_call_field_t)(int table, int index, int field);
...
///
typedef list_t (*policy_call_code_t)();
...
///
typedef list_t (*policy_call_section_t)(bstring name);
