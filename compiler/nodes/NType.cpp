...
void NType::resolveStruct(AsmGenerator& context)
{
	...
	for (DeclarationList::iterator i = context.m_RootNode->definitions.begin(); i != context.m_RootNode->definitions.end(); i++)
...
NType& NType::getExpressionType(AsmGenerator& context)
{
